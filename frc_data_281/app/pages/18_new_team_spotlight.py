...
from frc_data_281.db.cached_queries import get_event_list, get_oprs_and_ranks_for_team, get_team_list
from frc_data_281.analysis.opr import get_ccm_data_for_event_separated
from frc_data_281.analysis.dataset_tools import filter_for_team
...
metric_grid.metric("Record",
                   f"{team_stats.get('wins', NO_DATA_VALUE)}-{team_stats.get('losses', NO_DATA_VALUE)}-{team_stats.get('ties', NO_DATA_VALUE)}",
                   border=True)
